 ...
 * @param errback - Called when finished connecting to or launching the pm2 daemon process.
 */
export function connect(noDaemonMode: boolean, errback: ErrorCallback): void;
...
export function describe(
  process: string | number,
  errback: ErrorProcDescsCallback
): void;
 ...
 * @param errback
 */
export function sendSignalToProcessName(
 ...
 * @param errback
 */
export function startup(platform: Platform, errback: ErrorResultCallback): void;
 ...
 * @param cb
 */
export function sendDataToProcessId(
  proc_id: number,
  packet: object,
...
type ErrorProcCallback = (error: Error, proc: Proc) => void;
type ErrorProcDescCallback = (
  error: Error,
  processDescription: ProcessDescription
) => void;
type ErrorProcDescsCallback = (
  error: Error,
  processDescriptionList: ProcessDescription[]
) => void;
type ErrorResultCallback = (error: Error, result: any) => void;
type ErrorBusCallback = (error: Error, bus: any) => void;
